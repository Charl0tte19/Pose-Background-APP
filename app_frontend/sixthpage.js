...
class sixthpage extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            img: [ 
              props.route.params.img1,
              props.route.params.img2,
              props.route.params.img3,
              props.route.params.img4,
              props.route.params.img5
            ],
            select: 'null'
        };  
      };
  ...
  takePicture = async () => {
      ...
      let downloadResumable =FileSystem.createDownloadResumable(this.state.select, photo.uri)
                ...
                {images.map((image, index) => (
                      <TouchableHighlight
                          ...
                          onPress={() => {
                              ...
                              this.state.select = url+this.state.img[index]
                          }}
                      >
                      <View style={styles.slide1}>
                          <Image source={{uri: url+this.state.img[index]}} style={styles.image}></Image>                   
                      </View>
